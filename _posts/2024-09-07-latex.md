...
{% include figure.liquid loading="eager" path="assets/img/tikz_image.jpg" class="img-fluid rounded z-depth-1" %} 
...
{% include figure.liquid loading="eager" path="assets/img/circuitikz_image.jpg" class="img-fluid rounded z-depth-1" %} 
...
{% include figure.liquid loading="eager" path="assets/img/quantikz_image.jpg" class="img-fluid rounded z-depth-1" %} 
