...
{% include figure.liquid loading="eager" path="assets/img/tikz_image.png" class="img-fluid rounded z-depth-1" zoomable=true %} 
...
{% include figure.liquid loading="eager" path="assets/img/circuitikz_image.png" class="img-fluid rounded z-depth-1" zoomable=true %} 
...
{% include figure.liquid loading="eager" path="assets/img/quantikz_image.png" class="img-fluid rounded z-depth-1" zoomable=true %} 
